...
using System.Runtime.InteropServices;
    ...
    public   class TINI : IDisposable
    {
        ...
        { 
            ...
            int i = GetPrivateProfileString(IN_Section, IN_Key, " ", sb, (int)sb.Capacity, this._FilePath);
            return sb.ToString();
        }
        ...
        public string getKeyValue(string Section, string Key, string DefaultValue)
        {
            ...
            try
            {
                ...
                GetPrivateProfileString(Section, Key, "", sbResult, (int)sbResult.Capacity, this._FilePath);
