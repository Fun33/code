...
//using System.Data.Objects;
        ...
        //OpenDirDialog op = new OpenDirDialog(this.SBO_Application); 
// op.OnGetFile += GetPath;
...
public class OpenDirDialog
{
    ...
    private FolderBrowserDialog OpenFile = new FolderBrowserDialog();
            ...
            if (MyProcs.Length == 1)
            {
                ...
                for (int i = 0; i <= MyProcs.Length - 1; i++)
                {
                    ...
                    if (ret == DialogResult.OK)
                    {
                        if (OnGetFile != null)
                        {
                            OnGetFile(OpenFile.SelectedPath );
                            //CloseOpenDialog();//test//它是null
    ...
    public OpenDirDialog(SAPbouiCOM.Application fSBO)
    {
